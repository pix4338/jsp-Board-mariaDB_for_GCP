...
//BoardServlet.java(joinMembership.do)에서 넘긴 setAttribute 
...
<link href="https://fonts.googleapis.com/css?family=Noto+Sans+KR:700&display=swap" rel="stylesheet">
	...
	<script>
		function doA(){
			...
			alert("frm = "+frm);
			frm.action='nicknameCheckPro.jsp';
			frm.submit();
		}
	</script>
</head>
<body>
    <header class="manu">
    <form method="post" action="joinMembership.do" id="frm">
        <div class="main">
            <h1><a href=shopping.jsp>NONCODE</a></h1>
            <ul id="manu_bar">
                <li>  당일출고</li>
                <li>BEST 50</li>
                <li>NEW:5%SALE</li>
        ...
        <div class="secsion">
            <div id="login">
                ...
                <table id="tb2">
                    <tr>
                        <th class="thS">아이디 <b>*</b></th>
                        <th id="th1"><input type="text" name="idN"  maxlength="15"></th>
                    </tr>
                    <tr>
                        <th  class="thS">비밀번호 <b>*</b></th>
                        <th id="th1"><input type="password" name="pwdN"  maxlength="12" ></th>
                    </tr>
                    <tr>
                        <th class="thS">비밀번호 확인 <b>*</b></th>
                        <th id="th1"><input type="password" name="pwdNe"  maxlength="12"></th>
                    </tr>
                    <tr>
                        <th class="thS">닉네임 <b style="text-align: center">*</b><pre>(중복검사 필수)</pre></th>
                        <th id="th1"><input type="text"name="nickname"  maxlength="15"> 
                        <input type="button" value="닉네임 중복 검사" onclick="doA();" >
                        </th>
                    </tr>
                     <tr>
                        <th class="thS">생일</th>
						...
						<input type="text" name="day" value="일 " onFocus="this.value='';" style="width:70px;" maxlength="2">
                   		</th>
                    </tr>
                    <tr>
                        <th class="thS">주소</th>
        ...
        <input id="submit1"  type="submit" value="등록"><!-- onclick="javascript: form.action='joinMembership.do';" -->
		<input id="buttons" type="button" value="취소" OnClick="window.location='login.jsp'">
		</form>
            </header>
</body>
</html>
